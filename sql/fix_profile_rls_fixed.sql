...
-- By dropping and recreating with explicit permission checking and correct data types
DROP FUNCTION IF EXISTS get_complete_profiles_with_emails();

-- Create an improved function that respects admin privileges with correct data types
...
RETURNS TABLE (
    ...
    role VARCHAR,  -- Changed from TEXT to VARCHAR to match database schema
