...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-offwhite flex flex-col">
      {/* Hide header on mobile for My Rota and Breaks pages - bottom nav provides navigation */}
      <header className={`bg-white shadow-sm border-b border-gray-200 relative z-10 ${(location.pathname === '/my-rota' || location.pathname === '/brakes') ? 'hidden md:block' : ''}`} style={{ paddingTop: 'env(safe-area-inset-top)' }}>
