        ...
        <div className="bg-red-50 border border-red-200 rounded-xl p-4 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm bg-white text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-red-300 focus:border-red-300"
            />
          </div>
