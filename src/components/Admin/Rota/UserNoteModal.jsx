      ...
      <div className="bg-gray-900 border border-gray-700/30 rounded-lg shadow-xl w-full max-w-md mx-4">
        <div className="p-5">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-xl font-medium text-charcoal">User Note</h3>
            <button 
              onClick={onClose}
          ...
          <div className="bg-red-500/10 border border-red-500/30 rounded-md p-4 mb-4">
            <div className="flex items-start">
              ...
              <div>
                <p className="text-charcoal font-medium">Important Note for {formattedDate}</p>
          ...
          <div className="bg-gray-800/50 border border-gray-700/50 rounded-md p-4 mb-5">
            <p className="text-charcoal whitespace-pre-wrap">{note}</p>
          </div>
          ...
          <div className="flex justify-end space-x-3">
            <button
              onClick={onClose}
              className="px-4 py-2 bg-gray-800 text-charcoal rounded-md border border-gray-700 hover:bg-gray-700 transition-colors"
            >
              Cancel
            </button>
            <button
              onClick={onConfirm}
              className="px-4 py-2 bg-blue-600 text-charcoal rounded-md hover:bg-blue-700 transition-colors"
            >
              Assign Anyway
            </button>
          </div>
