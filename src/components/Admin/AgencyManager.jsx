...
export default function AgencyManager() {
  ...
  return (
    <div className="bg-white/5 rounded-lg p-4 mb-4 border border-white/10">
      <h3 className="text-lg font-semibold text-charcoal dark:text-white mb-4">Agency Management</h3>
      
      {/* Add new agency button */}
      {!showAddForm && (
        <button
          onClick={() => setShowAddForm(true)}
          className="mb-4 px-4 py-2 bg-blue-500/60 hover:bg-blue-600/60 border border-blue-400/30 rounded-lg text-charcoal dark:text-white transition-colors"
        >
          Add New Agency
        </button>
      )}
      ...
      {showAddForm && (
        <div className="mb-6 p-4 border border-white/20 rounded-lg bg-white/5">
          <h4 className="text-md font-medium text-charcoal dark:text-white mb-3">Add New Agency</h4>
          
          <div className="space-y-3">
            <div>
              <label className="block text-charcoal dark:text-white text-sm font-medium mb-1" htmlFor="new-agency-name">
                Agency Name*
              </label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-charcoal dark:text-white text-sm font-medium mb-1" htmlFor="new-agency-email">
                Email
              </label>
              <input
                type="email"
            ...
            <div>
              <label className="block text-charcoal dark:text-white text-sm font-medium mb-1" htmlFor="new-agency-contact">
                Contact Person
              </label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-charcoal dark:text-white text-sm font-medium mb-1" htmlFor="new-agency-phone">
                Phone Number
              </label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-charcoal dark:text-white text-sm font-medium mb-1" htmlFor="new-agency-notes">
                Notes
              </label>
              <textarea
                id="new-agency-notes"
            ...
            <div className="flex space-x-2 pt-2">
              ...
              <button
                ...
                disabled={loading}
                className="px-4 py-2 bg-white/10 hover:bg-white/20 border border-white/20 rounded-lg text-charcoal dark:text-white transition-colors"
              >
                Cancel
              </button>
            </div>
      ...
      {/* Agencies list */}
      <div className="mb-4">
        <h4 className="text-md font-medium text-charcoal dark:text-white mb-2">Existing Agencies</h4>
        
        {loading && agencies.length === 0 ? (
          <div className="text-charcoal dark:text-white text-center py-4">Loading agencies...</div>
        ) : agencies.length === 0 ? (
          <div className="text-charcoal dark:text-white/70 text-center py-4">No agencies found</div>
        ) : (
              ...
              <div 
                ...
                className={`p-3 rounded-md border ${
                  agency.is_active 
                    ...
                    : 'bg-white/5 border-white/10 text-charcoal dark:text-white/60'
                }`}
              >
                {editAgencyId === agency.id ? (
                  <div className="space-y-2">
                    <div>
                      <label className="block text-charcoal dark:text-white text-sm font-medium mb-1">
                        Agency Name*
                      </label>
                      <input
                        type="text"
                        ...
                        className="w-full px-3 py-2 bg-white/20 border border-white/30 rounded-md text-charcoal dark:text-white focus:outline-none focus:border-blue-500"
                        disabled={loading}
                      />
                    </div>
                    ...
                    <div className="flex space-x-2 pt-2">
                      <button
                        ...
                        disabled={loading}
                        className="px-3 py-1 bg-green-500/40 hover:bg-green-600/40 border border-green-400/30 rounded text-charcoal dark:text-white transition-colors"
                      >
                        Save
                      </button>
                      <button
                        ...
                        disabled={loading}
                        className="px-3 py-1 bg-white/10 hover:bg-white/20 border border-white/20 rounded text-charcoal dark:text-white transition-colors"
                      >
                        Cancel
                      </button>
                    </div>
                  ...
                  <div>
                    ...
                    {agency.email && (
                      <div className="mt-1 text-sm">
                        <span className="text-charcoal dark:text-white/70">Email:</span> {agency.email}
                      </div>
                    )}
                    
                    {agency.contact_person && (
                      <div className="mt-1 text-sm">
                        <span className="text-charcoal dark:text-white/70">Contact:</span> {agency.contact_person}
                      </div>
                    )}
                    
                    {agency.phone_number && (
                      <div className="mt-1 text-sm">
                        <span className="text-charcoal dark:text-white/70">Phone:</span> {agency.phone_number}
                      </div>
                    )}
                    
                    {agency.notes && (
                      <div className="mt-2 text-sm text-charcoal dark:text-white/80 border-t border-white/10 pt-2">
                        {agency.notes}
                      </div>
                    )}
                  </div>
