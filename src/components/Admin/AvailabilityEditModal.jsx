      ...
      >
        <div className="flex justify-between items-center mb-5">
          <div>
            ...
            <p className="text-charcoal dark:text-white/90 text-sm font-medium">{format(date, 'MMM d, yyyy')} - {dayOfWeek}</p>
          </div>
          <button
            type="button"
            className="text-charcoal dark:text-white/80 hover:text-charcoal dark:text-white hover:bg-white/10 p-1.5 rounded-full"
            onClick={onClose}
            aria-label="Close"
          >
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
              <button
                ...
                className={`rounded-lg py-3 px-2 flex justify-center items-center text-charcoal dark:text-white font-medium transition-all ${
                  status === 'available' 
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              className="w-full px-3 py-2 bg-white/10 backdrop-blur-sm border border-white/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-white/40 text-charcoal dark:text-white placeholder-white/50"
              rows="3"
          ...
          <div className="flex justify-end space-x-3">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 border border-white/30 rounded-lg text-charcoal dark:text-white hover:bg-white/20 transition-all active:scale-95"
            >
              Cancel
            </button>
            <button
              type="submit"
              className="px-5 py-2 bg-blue-500/80 border border-blue-400/40 text-charcoal dark:text-white rounded-lg hover:bg-blue-500/90 transition-all shadow-md hover:shadow-blue-500/30 active:scale-95"
            >
              Save
            </button>
          </div>
