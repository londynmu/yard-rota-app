...
export default function RedirectHandler() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-blue-900 to-green-500">
      <div className="max-w-md w-full p-6 bg-black/60 backdrop-blur-xl rounded-xl shadow-xl overflow-hidden border border-white/30 text-center">
        {errorDetails ? (
          <>
            <div className="text-center mb-6">
              <h2 className="text-xl font-semibold text-white mb-2">{message}</h2>
              <p className="text-white/70 mb-4">{errorDetails}</p>
              
              <button
                onClick={handleGoToLogin}
                className="mt-4 inline-block bg-white/20 backdrop-blur-sm text-white py-2 px-4 rounded-md border border-white/30 hover:bg-white/30"
              >
                Go to Login
              </button>
            </div>
            ...
            {/* Debug information */}
            <div className="mt-4 p-3 bg-gray-800 rounded text-left text-xs text-white/80 font-mono overflow-auto max-h-40">
          ...
          <>
            ...
            <p className="text-white/70 mb-4">You will be redirected automatically.</p>
            ...
            <div className="mt-4">
              <button
                onClick={handleGoToLogin}
                className="inline-block bg-white/20 backdrop-blur-sm text-white py-2 px-4 rounded-md border border-white/30 hover:bg-white/30"
              >
                Go to Login
              </button>
            </div>
